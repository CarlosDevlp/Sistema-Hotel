...
import controlador.CtrBuscarRol;
import dao.BasicDao;
 ...
 */
public class FrmBuscarRol extends StandardForm {
    CtrBuscarRol mCtrBuscarRol;
    /**
     * Creates new form FrmBuscarRol
     */
    public FrmBuscarRol() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cmbSeachParameters = new javax.swing.JComboBox<>();
        ...
        tbPestana.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Pestañas habilitadas"
            }
        ) {
        ...
        tbPestana.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane2.setViewportView(tbPestana);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(cmbSeachParameters, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(btnSearch))
                    .addComponent(cmbSeachParameters, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuscarRol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                FrmBuscarRol frmBuscarRol=new FrmBuscarRol();
                frmBuscarRol.setVisible(true);
                frmBuscarRol.createController();
    ...
    public javax.swing.JComboBox<String> cmbSeachParameters;
    ...
    public void createController(){
        mCtrBuscarRol=new CtrBuscarRol(this);
        mCtrBuscarRol.loadData();
    }
    @Override
    public Object getViewController() {        
        return mCtrBuscarRol;
    }
